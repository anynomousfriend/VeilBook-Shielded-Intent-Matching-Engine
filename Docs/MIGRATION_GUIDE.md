...
```bash
compact compile src/veilbook.compact src/managed/veilbook
```
...
After a successful compile, `src/managed/veilbook/` will contain:
...
import { Counter } from '@midnight-ntwrk/veilbook-contract';
